            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">اضافة مستفيد</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">اضافة مستفيد
                                    </li>
                                </ol>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <form class="row" action="{{ route('beneficiareis.store') }}" method="POST" id="create_new">
                                        ...
                                        <div class="col-xl-4 col-md-6 col-sm-12 mb-2">
                                            ...
                                            <input type="text" name="firstName" value="{{ old('firstName') }}" class="form-control credit-card-mask" placeholder="اسم الاول"  />
                                            @error('firstName')<span class="text-danger">{{ $message }}</span>@enderror
                                        </div>
                                        <div class="col-xl-4 col-md-6 col-sm-12 mb-2">
                                            <label for="credit-card">اسم الاب</label>
                                            <input type="text" name="secondName" value="{{ old('secondName') }}" class="form-control credit-card-mask" placeholder="اسم الاب"  />
                                        ...
                                        <div class="col-xl-4 col-md-6 col-sm-12 mb-2">
                                            ...
                                            <input type="text" name="lastName" value="{{ old('lastName') }}" class="form-control credit-card-mask" placeholder="اسم العائلة"  />
                                        ...
                                        <div class="col-xl-4 col-md-6 col-sm-12 mb-2">
                                            ...
                                            <input type="text" name="id_number" value="{{ old('id_number') }}" class="form-control credit-card-mask" placeholder="رقم الهوية"  />
                                        ...
                                        <div class="col-xl-4 col-md-6 col-sm-12 mb-2">
                                            ...
                                            <input type="text" name="family_member" value="{{ old('family_member') }}" class="form-control credit-card-mask" placeholder="عدد افراد الاسرة"  />
                                        ...
                                        <div class="col-xl-4 col-md-6 col-sm-12 mb-2">
                                            <div class="form-group">
                                                <label for="basicInput">اسم المشروع</label>
                                        ...
                                        <div class="col-xl-4 col-md-6 col-sm-12 mb-2">
                                            <label for="credit-card">maritial</label>
                                            <input type="text" name="maritial" value="{{ old('maritial') }}" class="form-control credit-card-mask" placeholder="maritial"  />
                                            @error('maritial')<span class="text-danger">{{ $message }}</span>@enderror
                                        </div>
                                        <div class="col-xl-4 col-md-6 col-sm-12 mb-2">
                                            <label for="status">الحالة</label>
                                            <select name="status_id" class="form-control">
                                                <option value="1" {{ old('status_id') == 1 ? 'selected' : null }}>فعال</option>
                                                <option value="0" {{ old('status_id') == 0 ? 'selected' : null }}>غير فعال</option>
                                            </select>
